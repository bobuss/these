...
Nous allons proposer dans ce chapitre un cadre d’utilisation des
 ...
 limites de ce type de dispositif dans le chapitre \@ref(communications).


Maintenant, du potentiel du système haptique (voir \@ref(conjuguent), \@ref(performances) et \@ref(perception)), nous pouvons déjà édicter plusieurs règles :
...
De plus, les modèles de l’utilisateur (en particulier [le modèle du
 processeur humain](#processeur)) nous indiquent quelques règles à respecter sur l’ergonomie des interfaces :
...
Et d’un point de vue logiciel, nous nous sommes appuyé sur l’architecture
 ...
 point par [@Reenskaug:1979a:ext], qui
...
D’un point de vue technique, le XMLHttpRequest est une fonction javascript
 ...
 [l’appendice](#ajax) pour plus de détails).
...
Le projet CDV (pour Cartographie pour Déficients Visuels ^[site web : <http://tactile.nrcan.gc.ca/>]),
...
Enfin, le CDV, encore, propose une application des travaux de [@gardner2001smart]. Il s’agit d’un
...
Tous nos testeurs ont donc souligné l’intérêt de l’approche, tout en
 ...
 cependant aux non-voyants) comme Google Maps^[http://maps.google.fr], Yahoo Local^[http://maps.yahoo.com/], ou encore MSN
...
La théorie de l’harmonie de Longuet-Higgins [@longuet1962letter] [@longuet2319626] propose
 ...
 théorie de Longuet-Higgins [@longuet1962letter] [@longuet2319626] affirme que les
...
Plus tard, [@steedman1972formal] a
...
L’ordinateur a beaucoup été utilisé pour l’apprentissage de la musique. Et
 ...
 employées peuvent être très différentes. On pourra se référer à [@brandao1999computers] pour une étude exhaustive des
...
Pour autant, ces approches oublient souvent les utilisateurs ayant une
 ...
 de la partition, en Braille. Les applications informatiques [@BrailleMusicEditor] et ([Toccata, 2002](047-bibliographie.html#Toccata)) fonctionnent de cette façon. Mais
...
Nous avons choisi cette notation, pour lui appliquer la localisation
 ...
 d’une note sont équidistants. Donc, la loi de [@fitts1954information] nous donne un temps égal pour accéder
