...
## 6.1  Des
 dispositifs, des interactions, de l’accessibilité[¶](#htoc132 "Lien permanent vers ce titre")
...
## 6.2  Pour
 aller plus loin...[¶](#htoc133 "Lien permanent vers ce titre")


### D’autres applications de la localisation relative[¶](#toc57 "Lien permanent vers ce titre")
...
* Chimie haptic : Le format de fichier CML (Chemical
 ...
 chimiques. Nous présentons en [annexe](042-la-feuille-de-style-xsl-pour-transformer-du-cml-en-svg.html#xslCML) une feuille de style XSLT (le langage de
 transformation d’un formalisme XML en un autre) qui transforme un fichier
 CML décrivant une molécule en deux dimension, en un fichier SVG exploitable
 avec notre approche.
* Body’Haptic (figure [6.1](#bodyhapt)): L’approche est ici plus indirecte. Nous avons cherché
...
![](img/body.png)
Figure 6.1 : le prototype Body’Haptic
...
### D’autres dispositifs : les écrans tactiles à retour
 haptique[¶](#toc58 "Lien permanent vers ce titre")


#### Motivations,
 justifications[¶](#htoc136 "Lien permanent vers ce titre")
...
#### Réalisations
 industrielles récentes[¶](#htoc137 "Lien permanent vers ce titre")


La firme Alpine [1](#note17) a proposé un écran tactile
 disposant d’un retour tactile (figure [6.2](#alpine)). Le
...
![](img/demo_touch.jpg)
![](img/iva-d300_hdr.jpg)
Figure 6.2 : IVA-D300 (DVD/CD/MP3/WMA Receiver/Mobile Multimedia
 Station)



La société Immersion [2](#note18), conceptrice de la souris que
 nous avons utilisée a également proposé récemment un écran tactile à retour
 tactile, le TouchScreen (figure [6.3](#touchscreen)). La
...
![](img/touchscreen.png)
Figure 6.3 : Immersion tactile touchscreen



Enfin, Tactiva [3](#note19), une start-up californienne a
 proposé le tactapad (figure [6.4](#tactapad)). Ce dispositif
...
![](img/tactapad2.jpg)
Figure 6.4 : le tactapad : peut-être le dispositif parfait ?



#### Problèmes
 subsistants[¶](#htoc138 "Lien permanent vers ce titre")
...
### Le mot de la fin[¶](#toc59 "Lien permanent vers ce titre")
