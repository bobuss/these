# Communications Homme-Machine {#communications}
...
Pour le reste, donc, les dispositifs sont surtout axés sur la
 ...
 tactile est celle visible sur la figure [2.21](#cap:Une-cellule-d'afficheur).
 On peut y voir une cellule
...
Les afficheurs brailles (figure [2.22](#cap:Une-plage-braille)) utilisent
...
Toujours dans la même approche, les sociétés
ABTIM ^[http://www.abtim.com] et
KGS ^[http://www.kgs-america.com/dvs.htm] ont équipé de cellules
des surfaces plus grande. Il ont ainsi réalisé des systèmes capables de reproduire des dessins en relief (figure [2.23](#cap:l'ADVANCED-DISPLAYS-for)).
...
Le retour de force a souvent été utilisé dans les domaines artistiques.
 ...
 instrument réel, comme pour le projet dAb (figure [2.27](#cap:le-syt=E8me-DAB)) :
 le dispositif utilisé est un PHANTOM, et
...
Dans une approche très différente, le projet PHASE (Plate-forme Haptique
 d’Application Sonore pour l’Eveil Musical (figure [2.28](#cap:La-plateforme-PHASE)))
 propose un moyen de création
