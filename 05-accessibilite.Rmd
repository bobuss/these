...
En 1980, l’organisation Mondiale de la Santé [(O.M.S., 1980)](047-bibliographie.html#O.M.S.1980), dans le rapport du rhumatologue
 britannique, Philip WOOD, introduit une clarification conceptuelle dans la
 définition du handicap, reprise en France sous le titre de " Classification
 internationale des handicaps (CIH) : déficiences, incapacités, désavantages.
 Il y est défini le handicap comme la conséquence des maladies sur la personne
 suivant trois plans :
...
Dans l’union européenne, c’est près d’un tiers de la population qui
 souffre de troubles divers (voir le tableau [4.1](#cap:Population-souffrant-de)).
...
Table 4.1 : Population souffrant de troubles
 dans les états membres de l’Union Européenne (adapté de [TIDE
 96]).



Le tableau [4.2](#cap:Populations-non-et) montre les
...
| France (1997) | 1 500 000 |
 110 000 + 250 000 |
| % de la population française | 2.6% |  |


Table 4.2 : Populations
 non et mal-voyantes en France et dans le monde
...
[(Grant et al., 2000)](047-bibliographie.html#Grant2000) ont conduit
...
En fait, il a été souvent dit que les aveugles développaient des capacités
 ...
 Dans la pratique, cependant, il a été prouvé que l’acuité haptique ([Heller, 1989](047-bibliographie.html#Heller1989)) était équivalente chez les
 non-voyants congénitaux, chez les non-voyants accidentels et chez les
 personnes voyantes.


### La représentation mentale d’un document par une personne
 non-voyante
...
Pourtant, les travaux de [(Hatwell,
 1993)](047-bibliographie.html#Hatwell1993) et de [(Martial, 1998)](047-bibliographie.html#Martial1998) ont
 montré que la représentation mentale des non-voyants est identique à celle
...
Dans une autre expérience, ([Manghi,
 2001](047-bibliographie.html#Manghi2001)) a demandé à ses sujets (l’étude portait sur des voyants et des
 non-voyants, et explorait également les effets de l’âge) de décrire un trajet
 dans une ville à quelqu’un. Les résultats se sont révélés très intéressants
 :
...
Contrairement à ceux de l’être humain, les médias non visuels en sortie
 restent limités (tableau [4.3](#cap:Sens-perceptifs-humain)).
...
Table 4.3 : Sens
 perceptifs humain et médias informatiques (adapté de ([Truillet, 1999](047-bibliographie.html#Truillet1999)))
...
[(Dufresne et al., 1995)](047-bibliographie.html#dufresne) ont montré
 l’impact et l’intérêt de la bimodalité audio-haptique pour les utilisateurs
 non-voyants. Le tableau [4.4](#cap:dufrene) indique le
...
Table 4.4 : Bonnes réponses dans différentes situations
 modales
...
Le *World Wide Web Consortium*, abrégé W3C[1](#note9), est
...
On pourra se référer aux [annexes](045-la-web-accessibility-initiative-(wai)-du-world-wide-web-consortium-(w3c).html#sec:La-Web-Accessibility), pour plus de détails.
...
D. Offen et B. Thomlinson ont développé une librairie de programmation
 permettant d’identifier l’agencement d’un document ([Offen et Thomlinson, 2001](047-bibliographie.html#offen)). L’OPENBook (c’est le nom
...
C. Ramstein est un des pionniers dans les interfaces utilisateur haptiques
 pour des personnes ayant un handicap visuel ([Ramstein et al., 1996](047-bibliographie.html#ramstein96etal)). Il a été à la
 tête de Haptic Technologies Inc. qui fabriquait et vendait les systèmes de
...
J. P. Fritz et K. E. Barner [Department of Electrical and Computer
 ...
 handicap visuel ([Fritz et Barner,
 1996](047-bibliographie.html#fritz96);[Fritz et Barner, 1999](047-bibliographie.html#fritz99)). Le c½ur du
...
Les laboratoires de British-Telecom ont étudié l’utilisation d’un
 ...
 format pour l’affichage des graphiques 3D sur le Web ([Hardwick et al., 1998](047-bibliographie.html#hardwick)). Le travail est basé
 sur une expérience acquise du développement d’un navigateur capable de
 piloter un retour de force à partir d’un fichier VRML. On retrouve ici
 l’approche de la bibliothèque de programmation Ghost™SDK de Sensable : le
...
Dans ces trois premières approches, il s’agit de découvrir un objet
 ...
 tableau [2.3](017-les-applications-du-retour-haptique.html#cap:Les-possilibit=E9s-des) :
...
J. A. Gardner et V. Bulatov ([Gardner et
 Bulatov, 2001](047-bibliographie.html#gardner)) se sont appuyés sur le format SVG (Scalable Vector
 Graphics) qui est le format XML pour les images vectorielles. Associé à une
 souris à retour de force et à un retour sonore, des images peuvent être
 rendue accessibles, tant qu’elles ne sont pas trop complexes aux non-voyants.
 Il s’agissait par exemple de localiser les positions des différentes régions
 ...
 la section [5.3](035-application-a-la-geographie-geogr-haptique.html#sub:L'application-G=E9ogr'Haptic).
...
Wai Yu, de l’université de Glasgow a beaucoup étudié l’utilisation d’une
 ...
 graphiques mathématiques à l’aide du PHANTOM ([Yu
 et al., 2001](047-bibliographie.html#Yu2001)). La figure [4.1](#cap:Exemples-de-graphes) est issue de cette application : lorsqu’il
...
![](img/hapticGraphs.jpg)
Figure 4.1 : Exemples
 de graphiques haptiquement augmentés
...
Plus tard, il a continué son travail en proposant cette même accessibilité
 ...
 construction automatique de graphiques haptiques [(Yu et al., 2002)](047-bibliographie.html#Yu2002), puis, il a donné à
 l’utilisateur non-voyant, la possibilité de créer ses propres graphiques
 ([Yu et al., 2003](047-bibliographie.html#Yu2003)).


Enfin, [(Sjöström, 2002)](047-bibliographie.html#Sjostrom2002) a également
...
[(Fritz et Barner, 1996)](047-bibliographie.html#fritz96) ont développé une
...
Dans ces travaux, les périphériques utilisés sont [des PHANTOMs](016-les-peripheriques-de-sortie-a-retour-haptique.html#cap:le-PHANTOM) ou l’Impulse Engine 3000 (figure [4.2](#cap:L'impulse-engine-3000)). En effet, pour générer des textures
...
[(Colwell, 1998)](047-bibliographie.html#Colwell1998) a étudié la
 ...
 (figure [4.2](#cap:L'impulse-engine-3000)). Ces travaux font
 partie des grandes références du domaine (voir les  [recommandations de conception](030-recommandations-de-conception.html#sub:Recommandations-de-conceptions).
...
Enfin, [(Sjöström, 2001)](047-bibliographie.html#Sjostrom2001) a étudié la
...
C’est la piste qu’ont suivis Dufresne ([Dufresne et al., 1995](047-bibliographie.html#dufresne)), Ramstein ([Ramstein, 1996](047-bibliographie.html#ramstein96)), O’Modhrain et Guillepsie
 ([Sile O’Modhrain et Guillepsie, 1996](047-bibliographie.html#omodhrain))
 et Rosenberg ([Rosenberg, 1997](047-bibliographie.html#Rosenberg1997)).
...
Très récemment, Wai Yu et ses collègues ont proposé un système multimodal
 de présentation de pages Internet ([Yu
 et al., 2005](047-bibliographie.html#Yu2005)). Il s’agissait d’appliquer l’approche qu’il a utilisée
...
Homere est un système qui a été réalisé par la société ONDIM[1](#note10), en
 partenariat avec le Commissariat à l’Energie Atomique et PSA Peugeot Citroën
 ([Ascher et al., 2002](047-bibliographie.html#Ascher2002)). Il s’agit
...
[(Colwell, 2001)](047-bibliographie.html#Colwell2001) a déduit de ses
 expériences une série de recommandations quant à l’utilisation du mode
 haptique pour les non-voyants : [3](#note11)
...
4. La taille d’un objet virtuel est perçue comme
 ...
 petite lorsque l’objet est exploré de l’extérieur.[4](#note12)
...
De même, [(Sjöström, 2002)](047-bibliographie.html#Sjostrom2002) a proposé
...
[3](#text11)
(1) et (2) concernent les textures virtuelles,
...
[4](#text12)
Les recommandations (3) et (4) suggèrent que si
 la taille des objets est un paramètre important, il peut être nécessaire de
 biaiser la taille de l’objet virtuel par rapport à sa taille réelle.
