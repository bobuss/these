...
En 1980, l’organisation Mondiale de la Santé [@world1980international], dans le rapport du rhumatologue
...
En fait, il a été souvent dit que les aveugles développaient des capacités
 ...
 Dans la pratique, cependant, il a été prouvé que l’acuité haptique [@heller1989texture] était équivalente chez les
...
Pourtant, les travaux de [(Hatwell,
 1993)](047-bibliographie.html#Hatwell1993) et de [@martial1998representation] ont
...
1. Leurs descriptions d’itinéraires ont été surtout
...
Table 4.3 : Sens
 perceptifs humain et médias informatiques (adapté de [@truillet1999modelisation])
...
D. Offen et B. Thomlinson ont développé une librairie de programmation
 permettant d’identifier l’agencement d’un document [@offen2001good]. L’OPENBook (c’est le nom
...
C. Ramstein est un des pionniers dans les interfaces utilisateur haptiques
 pour des personnes ayant un handicap visuel [@ramstein1996touching]. Il a été à la
...
Les laboratoires de British-Telecom ont étudié l’utilisation d’un
 ...
 format pour l’affichage des graphiques 3D sur le Web [@hardwick1998tactile]. Le travail est basé
...
Plus tard, il a continué son travail en proposant cette même accessibilité
 ...
 construction automatique de graphiques haptiques [@yu2002automatic], puis, il a donné à
...
Dans ces travaux, les périphériques utilisés sont
 [des PHANTOMs](016-les-peripheriques-de-sortie-a-retour-haptique.html#cap:le-PHANTOM)
...
Homere est un système qui a été réalisé par la société ONDIM ^[http://www.ondim.fr/], en
 partenariat avec le Commissariat à l’Energie Atomique et PSA Peugeot Citroën
 [@lecuyer2003homere]. Il s’agit
...
4. La taille d’un objet virtuel est perçue comme
 ...
 petite lorsque l’objet est exploré de l’extérieur. ^[Les recommandations (3) et (4) suggèrent que si
